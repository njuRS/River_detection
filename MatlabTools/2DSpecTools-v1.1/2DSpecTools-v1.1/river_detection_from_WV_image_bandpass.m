...
% 1. LOAD DATA %
[Z, dim] = ReadArcGrid('ndwisharpengs_lc8_006013_2015214_102.asc');
...
figure(s1d)
subplot(2,1,2)
semilogx(fv,Make2DFilt(fv, f, 'bandpass'),'b')
set(gca,'box','off','tickdir','out','ylim',[0 1.01])
xlabel('Radial frequency (m^{-1})')
ylabel('Filter')
% Filter the DEM
Zhp = SpecFilt2D(Z,dx,dy,f,'bandpass');
% Low-pass filter
Zlp = Z - Zhp;
%Zlp = SpecFilt2D(Z,dx,dy,[floLP fhiLP],'lowpass');
...
WriteArcGrid(xhp,yhp,Zhp,'orthowv03_ndwi20160707151203_for_wq7_21_bandpass_1500_600_200_50')
WriteArcGrid(xhp,yhp,Zlp,'orthowv03_ndwi20160707151203_for_wq7_21_bandpass_1500_600_200_50_left')
